...
function Onboarding() {
  ...
  const [showForm, setShowForm] = useState(false);
  const [form, setForm] = useState({ name:'', pos:'', area:'', empresa:'zavix', ingreso:'', manager:'' });
  ...
  return (
    <div style={{ padding: '1.25rem' }} className="fade-in">
      <div className="page-header">
        ...
        <button className="btn-primary" onClick={() => setShowForm(!showForm)}>+ Iniciar Onboarding</button>
      </div>
